    ...
    return(
        <nav >
            <ul className={styles.NavBar}>
                ...
                <li><a className={styles.NavBarButton} onClick={() => handleScroll("section4")}>Contact</a></li>
                <li><a className={styles.NavBarButton} onClick={() => handleScroll("section5")}>Resume</a></li>
            </ul>
        </nav>
    )
}